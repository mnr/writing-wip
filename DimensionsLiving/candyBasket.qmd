...
The basket outside room 207 always contains candy. I have never seen it empty. The invitation is obvious--you should take a piece. I've taken advantage of that implicit offer several times. Peanut butter cups are my favorite, not so much any other nut bars. Chocolate bars disappear in a day. I'm sorry to say I haven't been recording weekly observations on the type and quantity of the contents. I could use this data to create a beautiful graph, showing population over time.

The size of the basket restricts the contents. There isn't room for full size chocolate bars. Instead, expect to find bite-sized treats. Think *halloween trick-or-treat.* 

I've done some experimentation with candy preferences. My first was small suckers, also known as "dum dums." 



fruit?

// cost, size to fit in basket, availability, familiarity, personal preferences
