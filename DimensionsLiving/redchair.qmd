...
Our apartment at Dimensions living includes access to a security cage for large or dirty items. It's in the basement parking garage, next to a disordered pile of wheelchairs, walkers, assistive toilet devices, and easy lift recliners. I assume former residents left these behind. Former, as in *moved on*. I haven't dug for the history, but I suspect these are no longer useful to the previous owner or their children.
...
It's easy to see how the chair cradled its owner; late night television supplying unwatched light and unheard sound. Both chair and owner rested peacefully until that one morning when the owner did not greet the sunrise. Maintenance cleaned the apartment and hauled the chair downstairs.
...
I finish with the topper and turn to see the ghost and Janell considering the chair.
