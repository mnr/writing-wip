...
I did have a space heater. One of those gray, metal, 1,500-watt devices with the two chrome bars in the front, preventing fires if the unit were to tip over on its face. It tried its best to warm the room, but was no match for the high thermal conductivity of the wrap-around glass.
...
"No problem," I confidently assure Janell. "Our Honda CR-V has a tow hitch, we can rent a 6 x 12 trailer from U-Haul, I'll drive down, load up, and we're set!" I have all the enthusiasm, none of the experience.

## Adventures In Moving

The U-Haul dealer is willing to believe I know what I am doing and leaves me to attach the trailer. I back the CR-V up to the trailer and try to lift the hitch onto the ball. I lift with my legs (not my back). Can't do it.

"Hmmm...," I ponder. Nobody else is around except the trailer and the CR-V. They aren't talking.

But the CR-V has a jack for changing a tire. Perfect. I jack up the trailer, back up the CR-V, drop the jack, the hitch goes on the ball, problem solved. The jack goes back in the car, I connect the safety chain, drive around the parking lot once to check my work. I start off for Milwaukee!
...
-   **Known to others/Known to self:** I am driving to Milwaukee with a 6 x 12 trailer. This is obvious.
...
-   **Not known to others/Known to self:** I seem to be getting low on gas.

-   **Not known to others/Not known to self:** I have neglected to tighten the hitch latch to the ball.

Cruising down the highway at 65 mph (WARNING: DO NOT EXCEED 55 MPH WITH THIS TRAILER) I start to question my pre-flight checklist. Did I put on the safety chains? (yes). Did the trailer tires have air? (yes). Was the trailer empty? (yes). Did I tighten the coupler hitch to the ball? (Possibly not. Sure I did. Can't remember. Yes. No.) Perhaps I should check.
...
Three feet of drama later, the trailer stops. I run to the nearby woods to find a piece of wood small enough for me to lift and large enough to chock a 1,920 pound trailer. With a new appreciation for trailer behavior, I again jack up the tongue and successfully mount the hitch to the ball. I reattach the chains. And yes, I finally lock the trailer to the ball. I return to the freeway on a mission to fill the CR-V with gasoline.

## Gas. Rain.

The CR-V calculates the available range based on current MPG and gallons of gas in the tank. It's a computer trick added by one of the engineering interns Honda hires for the summer. *Available Range* doesn't really tell me anything more than what I could observe by looking at the gas gauge at the bottom of the speedometer. When the gas needle gets to the last quarter tank, I should fill up. That's where the needle is now.

I start watching the roadside signs for a freeway exit with a gas station. It has started to rain, so I turn on the wipers. First at intermittent, then low, then high as the abrupt storm obliterates the view of other cars and roadside features.

With the trailer dragging along behind, the CR-V is getting half the normal mileage per gallon of gas.
